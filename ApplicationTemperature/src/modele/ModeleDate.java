...
{
	 public static Calendar getDateTemperature(String date, String heure)	
	 	{
	        String[] separateurDate = date.split("/");
	        String[] separateurHeure = heure.split("h");

	        int jour = Integer.parseInt(separateurDate[1]);
	        int mois = Integer.parseInt(separateurDate[0])-1;
	 ...
	 public static Calendar getDateAccelerometre(String date, String heure)	
	 	{
	        String[] separateurDate = date.split("/");
	        String[] separateurHeure = heure.split("h");
